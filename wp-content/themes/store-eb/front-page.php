...
?>
	...
	<section class="categories pt-5 pb-5">
			...
			<div class="row mb-3">
				...
				<div class="categories__col col-md-4 col-sm-12 mb-3">
					<a href="<?php echo site_url('/product-category/clothing/accessories') ?>" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
				...
				<div class="categories__col sale col-md-8 col-sm-12 mb-3">
					<a href="<?php echo site_url('/special-offers') ?>" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
						<div class="bg-sale position-absolute top-0 bottom-0 end-0 start-0"></div>
						...
						<h2 class="position-absolute top-50 start-0 end-0 mb-0 text-center text-white">Special Offers</h2>
					</a>
				</div>
