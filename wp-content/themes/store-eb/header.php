...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'store-eb' ); ?></a>
			...
			<div class="row">
				...
				<ul class="announcement-bar__list">
					<li>
						...
						<a href="tel: +46 555 1212" class="text-decoration-none"> +46 555 1212</a>
					</li>

					<li>
						<i class="bi bi-envelope rounded-circle"></i>
						<a href="mailto:hello@eb.shop" class="text-decoration-none"> hello@eb.shop</a>
					</li>
				</ul>
			...
			<div class="row">
				<div class="col-12 d-flex justify-content-center">
					<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false">
						...
						<?php esc_html_e( 'Primary Menu', 'store-eb' ); ?>
					</button>
				</div>
